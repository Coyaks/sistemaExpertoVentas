    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div>
                    <button id="filterCompra" class="btn btn-outline-info btn-sm">Filtrar</button>
                    <button id="resetCompra" class="btn btn-outline-warning btn-sm">Reset Tabla</button>
                </div>
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <!-- /////////////////// tabla: records ///////////////////  -->
                    <table id="tablaCompra" class="display nowrap table table-striped table-bordered tablaSeg table-condensed" style="width:100%">
