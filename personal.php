...
<head>
  ...
  <link rel="icon" href="img/store.ico">
  ...
  <!-- DataTables editable CDN -->

  <!-- iconos de fontawesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <!-- ESTILOS PROPIOS PARA TABLA -->
  <link rel="stylesheet" href="css/estilosTablas">
</head>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Admin Cabel</span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <!-- MODULO USUARIOS -->
                <li class="nav-item">
                  <a href="admin.php?modulo=usuarios" class="nav-link <?php echo ($modulo == 'usuarios') ? "active" : " "; ?>">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="admin.php?modulo=pacientes" class="nav-link <?php echo ($modulo == 'pacientes') ? "active" : " "; ?>">
                        <i class="far fa-address-card nav-icon"></i>
                        <p>Gestión de Pacientes</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="admin.php?modulo=medida" class="nav-link <?php echo ($modulo == 'medida') ? "active" : " "; ?>">
                      <i class="fas fa-eye nav-icon"></i>
                        <p>Registrar medida</p>
                      </a>
                    </li>
                  </ul>
                ...
                <!-- MODULO PRODUCTOS -->
                <li class="nav-item">
                  <a href="admin.php?modulo=productos" class="nav-link <?php echo ($modulo == 'productos' || $modulo == '') ? "active" : " "; ?>">
                ...
                <!-- MODULO MOVIMIENTOS -->
                <li class="nav-item">
                  <a href="admin.php?modulo=movimientos" class="nav-link <?php echo ($modulo == 'movimientos') ? "active" : " "; ?>">
...
<!-- //////////////////////////// FIN BARRA LATERAL 'ASIDE' //////////////////////////// -->
  ...
  <script src="mainCrudPacientes.js"></script>  
  ...
  <script src="mainCrudMedida.js"></script>
